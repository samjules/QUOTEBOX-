...
export async function sendOnboardingInviteNotifications({ leadName, leadEmail, leadPhone, url }: SendOnboardingInviteArgs) {
  ...
  if (apiKey) {
    try {
      ...
      await resend.emails.send({
        from,
        to: leadEmail,
        subject: "You're invited to Quotebox",
        html: `
          <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;max-width:560px;margin:0 auto">
            ...
            <div style="background:#ffffff;padding:32px;border:1px solid #e2e8f0;border-top:none;border-radius:0 0 12px 12px">
              ...
              <p style="color:#475569;font-size:0.95rem;line-height:1.6;margin:0 0 8px">
                You're invited to set up your Quotebox account.
              </p>
              <p style="color:#475569;font-size:0.95rem;line-height:1.6;margin:0 0 24px">
                Click below to create your password, activate your $750/mo retainer, and get your quote form live.
              </p>
  ...
  if (leadPhone) {
    smsSent = await sendSms(
      leadPhone,
      `Hi ${leadName.split(' ')[0]}, this is Quotebox! Set up your account here: ${url}`
    )
  }
