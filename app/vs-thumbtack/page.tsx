...
const faqs = [
  ...
  },
  {
    ...
    a: 'Thumbtack Pro plans start at $0 but Thumbtack Promote (to appear at the top of search results) runs $119–$200+ per month on top of per-lead bid fees.',
  },
  {
    q: 'How much does Quotebox cost?',
    a: '$1 for your first month, full access, no feature limits. After that it renews at a flat $34/month — no per-lead fees, no bidding, no matter how many leads come in.',
  },
  {
    q: 'Are Quotebox leads exclusive?',
    a: 'Yes. When a customer fills out your Quotebox form they see only your company. No other mover or junk hauler receives that same lead.',
  },
  {
    q: "What happens to my Thumbtack customers when I switch?",
    a: "Thumbtack owns the customer relationship. When you switch away, you lose access to those reviews and contacts. With Quotebox you collect the customer's direct contact info in your own CRM — they become your customer, not the platform's.",
  },
]

const rows = [
  { feature: 'Lead exclusivity', qb: 'Exclusive — only you', tt: 'Shared with up to 5 companies', qbWin: true },
  { feature: 'Pricing model', qb: 'Flat $34/mo, unlimited leads', tt: '$3–$75+ bid fee per quote (win or lose)', qbWin: true },
  { feature: 'First month cost', qb: '$1', tt: 'Full bid fees from day one', qbWin: true },
  { feature: 'Pay per lead you don’t win', qb: 'Never — flat subscription', tt: 'Yes — you pay to bid regardless of outcome', qbWin: true },
  ...
  { feature: 'Automatic SMS & email follow-up', qb: 'Built in', tt: 'Not included', qbWin: true },
  { feature: 'CRM & lead pipeline', qb: 'Built in', tt: 'Not included', qbWin: true },
  { feature: 'Mobile app', qb: 'Included', tt: 'Not included', qbWin: true },
  { feature: 'Ad targeting control', qb: 'City / zip / radius, your own Meta account', tt: 'Platform-controlled', qbWin: true },
  { feature: 'Contract required', qb: 'None — cancel anytime', tt: 'Promote plan requires commitment', qbWin: true },
    ...
    <div style={{ fontFamily: "'Nautic', sans-serif", color: '#201d3d', background: '#fff' }}>
      ...
      <section style={{ background: '#453bc2', color: 'white', padding: '80px 24px 72px', textAlign: 'center' }}>
        <div style={{ maxWidth: 740, margin: '0 auto' }}>
          ...
          <h1 style={{
            ...
            <span style={{ color: '#f4a93c' }}>Ditching Thumbtack</span>
          </h1>
      ...
      <section id="compare" style={{ padding: '72px 24px', background: '#f9fafb' }}>
        <div style={{ maxWidth: 840, margin: '0 auto' }}>
          <h2 style={{
            fontFamily: "'Nautic', sans-serif", fontSize: 'clamp(1.7rem, 3vw, 2.4rem)',
      ...
      <section style={{ padding: '72px 24px', background: '#fff' }}>
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          ...
          <p style={{ color: '#4b5563', lineHeight: 1.75, fontSize: '1rem', marginBottom: 20 }}>
            Say you&apos;re a moving company looking for 10 jobs a month. On Thumbtack you might pay $20–$50 per bid — and if five other movers are also bidding, you&apos;re winning roughly one in five. That means you could spend $400–$1,000 in bid fees to land 10 jobs, plus a Promote subscription on top if you want to rank at all.
          </p>
          <p style={{ color: '#4b5563', lineHeight: 1.75, fontSize: '1rem', marginBottom: 20 }}>
            On Quotebox, those same leads cost the same flat <strong>$34/month</strong> whether you get 5 leads or 50 — no per-bid fees, no losing money on quotes you don&apos;t win.
          </p>
          <p style={{ color: '#4b5563', lineHeight: 1.75, fontSize: '1rem', margin: 0 }}>
            And unlike Thumbtack, your customers&apos; contact information lives in your own CRM. You can follow up, re-market, and build a repeat-client base that no platform can ever take away.
          </p>
        </div>
      </section>
