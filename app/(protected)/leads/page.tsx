    ...
    <div className="relative min-h-screen" style={{ background: '#ededf2' }}>
      ...
      <div className="relative" style={{ zIndex: 1 }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Banners */}
          {!hasAccess && (
            <div className="mb-6 rounded-2xl p-4 flex items-center justify-between" style={{ background: 'rgba(251,191,36,0.15)', border: '1px solid rgba(251,191,36,0.4)' }}>
              <div className="flex items-center gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 flex-shrink-0" style={{ color: '#d97706' }}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
                </svg>
                <div>
                  <p className="font-semibold text-sm" style={{ color: '#92400e' }}>No active subscription</p>
                  <p className="text-sm" style={{ color: '#b45309' }}>Subscribe to a plan to start receiving new leads.</p>
                </div>
              </div>
              <Link href="/billing" className="ml-4 flex-shrink-0 px-4 py-2 rounded-xl text-sm font-semibold text-white transition" style={{ background: '#d97706' }}>
                View Plans
              </Link>
            </div>
          )}
