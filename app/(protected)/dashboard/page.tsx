      ...
      <div className="relative" style={{ zIndex: 10 }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 pb-10 space-y-5" style={{ marginTop: hasBg ? 0 : 8 }}>
            ...
            <div className={CARD} style={CARD_STYLE}>
              <div className="p-6">
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900" style={{ fontFamily: "'Brraelyn', sans-serif", fontSize: 15 }}>LTV Calculator</h3>
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    <h3 className="font-bold text-gray-900" style={{ fontFamily: "'Brraelyn', sans-serif", fontSize: 15 }}>Monthly leaderboard</h3>
                  </div>
          ...
          <div className={`${CARD} p-6`} style={CARD_STYLE}>
            <h3 className="font-bold text-gray-900 mb-4" style={{ fontFamily: "'Brraelyn', sans-serif", fontSize: 15 }}>
              Quick Actions
            </h3>
  ...
  return (
    <div className={`${CARD} overflow-hidden`} style={CARD_STYLE}>
      ...
      <div className="px-6 pt-5 pb-4 flex items-center justify-between" style={{ borderBottom: '1px solid rgba(0,0,0,0.05)' }}>
        <div>
          <h3 className="font-bold text-gray-900" style={{ fontFamily: "'Brraelyn', sans-serif", fontSize: 15 }}>Today</h3>
