...
export const metadata: Metadata = {
  title: 'Exclusive Plumbing Leads — $15 Per Lead | Quote Box',
  description: 'Buy exclusive plumbing leads from Facebook & Instagram ads. Every leak repair, pipe installation, and water heater lead goes only to you. $15 per lead, no monthly fees, no sharing.',
  keywords: ['plumbing leads', 'exclusive plumbing leads', 'buy plumbing leads', 'plumber leads', 'plumbing contractor leads', 'pipe repair leads'],
  alternates: { canonical: 'https://quote-box.com/plumbing-leads' },
  openGraph: {
    title: 'Exclusive Plumbing Leads — $15 Per Lead | Quote Box',
    description: 'Stop sharing plumbing leads with competitors. $15/lead, exclusive, instant delivery, no monthly fees.',
...
const faqs = [
  {
    q: 'How much do plumbing leads cost on Quote Box?',
    a: 'A flat $15 per lead — regardless of job size or type. No monthly fee, no subscription, no bidding. You only pay when a real customer contacts you.',
  },
  {
    q: 'Are plumbing leads exclusive?',
    a: 'Yes. When a homeowner fills out your plumbing quote form, you are the only plumber who receives their details. No other plumber on Quote Box sees that lead.',
  },
  {
    q: 'What types of plumbing jobs can I get leads for?',
    a: 'Any plumbing service — leak repairs, drain cleaning, water heater installation, pipe replacement, bathroom remodels, sewer line inspection, and more. You customize the form to match your services.',
  },
  {
    q: 'How does Quote Box compare to HomeAdvisor / Angi for plumbing?',
    a: "HomeAdvisor (now Angi) charges a monthly fee plus $20–$60 per plumbing lead — and those leads are shared. Quote Box charges $15 per exclusive lead with zero monthly fees.",
  },
  {
    q: 'Can I get emergency plumbing leads?',
    a: "Yes. You can add an 'urgency' field to your form so customers can flag emergency jobs. You'll see it instantly in your dashboard and can follow up within minutes.",
  },
]
      ...
      <section style={{ background: '#1a1a2e', color: 'white', padding: '80px 24px 72px', textAlign: 'center' }}>
        <div style={{ maxWidth: 740, margin: '0 auto' }}>
          ...
          <p style={{ fontSize: '1.05rem', color: 'rgba(255,255,255,0.7)', lineHeight: 1.75, marginBottom: 40, maxWidth: 580, margin: '0 auto 40px' }}>
            Facebook & Instagram ads drive homeowners to your branded plumbing quote form. You get each lead exclusively — no other plumber competes for the same customer. $15 per lead, no monthly fees.
          </p>
          <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link href="/signup" style={{
              ...
              Get plumbing leads — free to start
            </Link>
      ...
      <section style={{ padding: '72px 24px', background: '#fff' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          <h2 style={{ fontFamily: "'Oswald', sans-serif", fontSize: 'clamp(1.8rem, 3.5vw, 2.6rem)', fontWeight: 700, textAlign: 'center', marginBottom: 48 }}>
            Why plumbers choose Quote Box
          </h2>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 24 }}>
            {[
              { icon: '🔒', title: '100% exclusive — no shared leads', body: 'Every homeowner who fills out your form is talking to you and only you.' },
              { icon: '🆘', title: 'Capture emergency jobs', body: 'Add urgency fields to your form so you can identify and call back emergency plumbing jobs within minutes.' },
              { icon: '📍', title: 'Only your service area', body: 'Your ads run in the exact zip codes your plumbing crew covers — no wasted spend or leads you can\'t reach.' },
              { icon: '⚡', title: 'Real-time lead alerts', body: 'Instant notification the moment a homeowner hits submit — name, number, service needed.' },
              { icon: '💰', title: '$15 per lead, zero monthly fee', body: 'No subscription. No bidding against other plumbers. Pay only when a real lead arrives.' },
      ...
      <section style={{ padding: '72px 24px', background: '#FFE500' }}>
        <div style={{ maxWidth: 580, margin: '0 auto', textAlign: 'center' }}>
          <h2 style={{ fontFamily: "'Oswald', sans-serif", fontSize: 'clamp(2rem, 4vw, 3rem)', fontWeight: 800, color: '#1a1a2e', marginBottom: 16 }}>
            Keep your plumbing crew busy
          </h2>
          <p style={{ color: '#1a1a2e', opacity: 0.7, marginBottom: 32, fontSize: '1rem', lineHeight: 1.65 }}>
            Build your branded plumbing quote form in 5 minutes. $15 per exclusive lead. Free to sign up.
          </p>
          <Link href="/signup" style={{
