        ...
        {step === 1 && (
          <>
            ...
            <div style={{ display: 'flex', gap: 12, marginTop: 16 }}>
              <button onClick={() => setStep(0)} style={{ flex: 1, padding: '14px 24px', borderRadius: 10, border: '1px solid rgba(255,255,255,0.15)', background: 'transparent', color: 'white', fontWeight: 600, cursor: 'pointer', fontSize: '0.95rem', fontFamily: "'Brraelyn', sans-serif" }}>
                Back
              </button>
              <button
