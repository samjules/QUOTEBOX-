...
export default function CrmDashboard({ leads: initialLeads }: { leads: SalesLead[] }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', background: '#0d0d1a', fontFamily: "'Sanguard', sans-serif", color: 'white' }}>
          ...
          <div style={{ display: 'flex', gap: 12, marginBottom: 20, alignItems: 'center', flexWrap: 'wrap' }}>
            <input
              ...
              style={{
                ...
                outline: 'none', width: 260, fontFamily: "'Sanguard', sans-serif",
              }}
            />
                            ...
                            <div style={{ marginTop: 10, padding: '12px 14px', background: 'rgba(255,255,255,0.03)', borderRadius: 8, border: '1px solid rgba(255,255,255,0.06)' }} onClick={(e) => e.stopPropagation()}>
                              ...
                              <textarea
                                ...
                                style={{
                                  ...
                                  outline: 'none', resize: 'vertical', fontFamily: "'Sanguard', sans-serif", boxSizing: 'border-box',
                                }}
                              />
