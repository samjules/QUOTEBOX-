      ...
      <div className="flex flex-col h-full">
        ...
        <div className="p-4 border-t border-gray-800">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-gray-800 text-gray-300 px-4 py-2.5 rounded-lg hover:bg-red-600 hover:text-white transition text-sm font-medium"
          >
